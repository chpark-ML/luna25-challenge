...
class Configuration(object):
    def __init__(self) -> None:
        ...
        # Working directory
        self.WORKDIR = Path("/home/juho.jung/LUNA25_Challenge/luna25-baseline-public")
        ...
        self.DATADIR = Path("/team/team_blu3/lung/data/2_public/LUNA25_Original/luna25_nodule_blocks")
        # Path to the folder containing the CSVs for training and validation.
        self.CSV_DIR = Path("/home/juho.jung/LUNA25_Challenge/luna25-baseline-public/label")

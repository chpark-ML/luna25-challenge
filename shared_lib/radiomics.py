...
class RadiomicsFeatureKeys:
    ...
    firstorder: List[str] = field(default_factory=lambda: [
    ...
    glrlm: List[str] = field(default_factory=lambda: [
    ...
    glszm: List[str] = field(default_factory=lambda: [
    ...
    gldm: List[str] = field(default_factory=lambda: [

"""Do not edit. This is copied from https://github.com/wolny/pytorch-3dunet/blob/master/pytorch3dunet/unet3d/model.py"""

import importlib

import torch.nn as nn

import projects.common.models.third_party.buildingblocks as bb
...
class Abstract3DUNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # create encoder path
        self.encoders = bb.create_encoders(
            in_channels,
            f_maps,
            basic_module,
            conv_kernel_size,
        ...
        # create decoder path
        self.decoders = bb.create_decoders(
            f_maps,
            basic_module,
            conv_kernel_size,
            conv_padding,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(ResidualUNet3D, self).__init__(
            ...
            out_channels=out_channels,
            final_sigmoid=final_sigmoid,
            basic_module=bb.ExtResNetBlock,
            f_maps=f_maps,
            layer_order=layer_order,
            num_groups=num_groups,
            num_levels=num_levels,

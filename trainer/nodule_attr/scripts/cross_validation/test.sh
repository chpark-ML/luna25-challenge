...
path_best_model_name=cls_all_model_${model_num}_val_fold${val_fold}
...
HYDRA_FULL_ERROR=1 python3 main.py \
  ...
  "run_modes=['val', 'test']" \
  path_best_model=/nvme1/5_personal/chpark/nodule_attr/outputs/cls/baseline/${path_best_model_name}/model_fine.pth

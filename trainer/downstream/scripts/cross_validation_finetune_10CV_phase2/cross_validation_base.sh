...
run_name=cv_fine_val_fold${val_fold}_10CV_phase2

LR=1e-4
epoch=100
model_path=/opt/challenge/trainer/downstream/outputs/default/cv_fine_val_fold${val_fold}_10CV/model_auroc.pth

...
run_name=cv_fine_val_fold${val_fold}_10CV

LR=1e-3
epoch=20
fold_key=fold_10
model_path=/team/team_blu3/lung/project/luna25/pretrained/nodule_attr_seg_KD_7CV/cls_all_KD_val_fold6/model_loss.pth

...
LR=1e-3
epoch=100
model_path=/team/team_blu3/lung/project/luna25/pretrained/nodule_attr_seg_logistic_fmaps48_model7_7CV/cls_all_model_7_val_fold${val_fold}_7CV/model_loss.pth

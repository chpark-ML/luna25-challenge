...
class AddCoords(nn.Module):
    ...
    def forward(self, input_tensor):
        ...
        if self.rank == 1:
            ...
            xx_channel = xx_channel.to(input_tensor, non_blocking=True)
            ...
            xx_channel = xx_channel.to(input_tensor, non_blocking=True)
            yy_channel = yy_channel.to(input_tensor, non_blocking=True)
            ...
            xx_channel = xx_channel.to(input_tensor, non_blocking=True)
            yy_channel = yy_channel.to(input_tensor, non_blocking=True)
            zz_channel = zz_channel.to(input_tensor, non_blocking=True)
...
class CoordConv3d(nn.modules.conv.Conv3d):
    def __init__(
        self,
        in_channels,
        out_channels,

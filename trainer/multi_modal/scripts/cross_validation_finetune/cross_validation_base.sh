...
run_name=cv_fine_val_fold${val_fold}_6CV

nodule_attr_model_name=cls_all_model_5_val_fold${val_fold}_6CV
model_path=/team/team_blu3/lung/project/luna25/pretrained/nodule_attr_seg_fmaps24_6CV_v3/${nodule_attr_model_name}/model_loss.pth
max_lr=3e-4

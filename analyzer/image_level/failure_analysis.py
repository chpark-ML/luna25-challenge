...
class FailureAnalyzer:
    ...
    def generate_report(self, output_dir: str) -> str:
        ...
        report = []
        report.append("# Image Level Model Failure Analysis Report\n")
        ...
        report.append(f"- False Positives: {len(failures['false_positives'])}")
        report.append(f"- False Negatives: {len(failures['false_negatives'])}")
...
def main(config: DictConfig):
    ...
    # Initialize analyzer
    analyzer = FailureAnalyzer(df, model_cols, ensemble_col)
    
    # Create output directory
    output_dir = "failure_analysis_output"
    os.makedirs(output_dir, exist_ok=True)
